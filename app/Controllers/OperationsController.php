...
final class OperationsController
{
    ...
    private function contractGenerate(int $userId):void
    {
        ...
        $vars=[
            ...
            'guest_full_name'=>$r['nome_cliente'],'guest_nationality'=>$_POST['guest_nationality']??null,'guest_marital_status'=>$_POST['guest_marital_status']??null,'guest_profession'=>$_POST['guest_profession']??null,'guest_rg'=>$_POST['guest_rg']??null,'guest_cpf'=>$r['cpf_cliente'],'guest_address'=>$_POST['guest_address']??null,'guest_phone'=>$r['telefone'],'guest_email'=>$r['email'],
