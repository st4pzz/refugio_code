...
<head>
    ...
    <link rel="stylesheet" href="<?= e(base_url('assets/css/admin.css?v=5')) ?>"><link rel="stylesheet" href="<?= e(base_url('assets/css/admin-operations.css?v=8')) ?>"><link rel="stylesheet" href="<?= e(base_url('assets/css/admin-calendar.css?v=1')) ?>"><link rel="stylesheet" href="<?= e(base_url('assets/css/reviews-admin.css?v=1')) ?>">
</head>
